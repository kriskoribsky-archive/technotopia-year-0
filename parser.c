    ...
    struct command *commands[] =
        {
            ...
            // create_command("Explore", "Scan room for information.", "^(EXPLORE|LOOK AROUND|OBSERVE)$", 2),
            ...
            // create_command("North", "Go north from your current position.", NULL, 0),
            // create_command("South", "Go south from your current position.", NULL, 0),
            // create_command("East", "Go east from your current position.", NULL, 0),
            // create_command("West", "Go west from your current position.", NULL, 0),

            // create_command("About", "Show a short introduction to the story.", NULL, 0),
            // create_command("Version", "Game version number and author contact.", NULL, 0),

            // create_command("Quit", "Quit the game.", NULL, 0),
            // create_command("Restart", "Restart the game.", NULL, 0),
